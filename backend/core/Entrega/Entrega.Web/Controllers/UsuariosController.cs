...
using Entrega.Web.Models.Usuarios.Usuario;
...
namespace Entrega.Web.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public UsuariosController(DbContextEntrega context, IConfiguration config)
        {
            _context = context;
            _config = config;
        }
       ...
       /* [HttpGet("[action]")]
         public async Task<IEnumerable<UsuarioViewModel>> VerUsuarios()
         {
            ...
            var consulta =  _context.Usuarios.Count(u =>u.idusuario.ToString)
